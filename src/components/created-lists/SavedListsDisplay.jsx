import React from 'react';
    ...
    const SavedListsDisplay = ({ wordLists, activeListId, onLoadList, onDeleteList }) => {
      ...
      return (
        <div className="mb-6 w-full max-w-md mx-auto">
          ...
          {wordLists.length === 0 ? (
            ...
            <div className="max-h-40 overflow-y-auto space-y-1.5 p-1.5 bg-secondary/50 rounded-md border border-primary/30">
              {wordLists.map(list => (
