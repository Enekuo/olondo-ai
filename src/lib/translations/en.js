...
export const en = {
  ...
  homeSubtitle: 'Enter your base idea or upload information (PDF, copied text, links...), and let AI create texts or summaries for you in seconds.',
  homeParagraph: 'Olondo AI is your space to generate content, collaborate, and listen to the result with synthetic voice.',
