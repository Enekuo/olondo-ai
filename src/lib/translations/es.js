...
export const es = {
  ...
  welcome_part1: 'Te damos la bienvenida a',
  homeSubtitle: "Introduce tu idea base o vuelca la información (PDF, texto copiado, enlaces…), deja que la IA cree textos o resúmenes para ti en segundos y escúchalos en voz alta donde y cuando quieras.",
  homeParagraph: "Olondo.AI convierte la lectura en una experiencia auditiva para que aprendas o te inspires sin interrumpir tus actividades.",
