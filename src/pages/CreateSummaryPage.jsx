        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative flex justify-center md:justify-start order-first">
            <div className="relative">
              {/* Bocadillo ENCIMA de la mascota con triángulo hacia abajo */}
              {speechText && speechText !== "create_summary_speech" && (
                <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-md px-4 py-2 rounded-2xl text-sm text-slate-800 dark:text-slate-200 relative">
                  {speechText}
